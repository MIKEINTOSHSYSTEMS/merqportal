...
<div role="tabpanel" class="tab-pane" id="purchase_orders">
    <div class="form-group">
        <label class="control-label" for="purchase_order_prefix"><?php echo _l('settings_sales_purchase_order_prefix'); ?></label>
        <input type="text" name="settings[purchase_order_prefix]" class="form-control" value="<?php echo get_option('purchase_order_prefix'); ?>">
    </div>
    <hr />
    <i class="fa-regular fa-circle-question pull-left tw-mt-0.5 tw-mr-1" data-toggle="tooltip" data-title="<?php echo _l('settings_sales_next_purchase_order_number_tooltip'); ?>"></i>
    ...
    <div class="form-group">
        ...
        <div class="radio radio-primary radio-inline">
            ...
            <label for="e_number_based"><?php echo _l('settings_sales_purchase_order_number_format_number_based'); ?></label>
        </div>
        <div class="radio radio-primary radio-inline">
    ...
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            <select name="settings[default_purchase_orders_pipeline_sort]" id="default_purchase_orders_pipeline_sort" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
        ...
        <div class="col-md-5">
            <div class="mtop30 text-right">
                <div class="radio radio-inline radio-primary">
                    <input type="radio" id="k_desc_purchase_order" name="settings[default_purchase_orders_pipeline_sort_type]" value="asc" <?php if (get_option('default_purchase_orders_pipeline_sort_type') == 'asc') {
                                                                                                                                                echo 'checked';
                                                                                                                                            } ?>>
                    <label for="k_desc_purchase_order"><?php echo _l('order_ascending'); ?></label>
                </div>
                <div class="radio radio-inline radio-primary">
                    <input type="radio" id="k_asc_purchase_order" name="settings[default_purchase_orders_pipeline_sort_type]" value="desc" <?php if (get_option('default_purchase_orders_pipeline_sort_type') == 'desc') {
                                                                                                                                                echo 'checked';
                                                                                                                                            } ?>>
